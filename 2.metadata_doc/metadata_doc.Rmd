---
title: "Fish and Wildlife Service Sea Temperature data"
author: "Allie Hunter, FWS"
date: "12/06/2021"
...
p_first_name <- c("Allie", "Camila")
p_middle_in <- c("", "")
p_last_name <- c("Hunter", "Vargas Poulsen")
...
Description <- c("2014", "2021", "On-going")
...
# **UPDATE NAMES**
cat_vars <- read.delim2(here::here(paste0("3.data_attributes/catvars_", files_names$file_name[2],".txt")))
