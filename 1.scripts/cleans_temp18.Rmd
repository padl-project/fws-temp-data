...
This scripts cleans csv files provided by Allie Hunter from Fish and Wildlife Service with Sea Temperature data for Palmyra Atoll, data from SeaTempLoggers 2018.

Date range goes from: 2017-08-31 to 2018-11-14
...
write_csv(final_temp, here::here("8.intermediate_files/2017_2018_sea_temp.csv"))
...
```{r}
meta_list <- list(meta1, meta2, meta3, meta4, meta5, meta6, meta7, meta8, meta9, meta10)

names(meta_list) <- c("meta1", "meta2", "meta3", "meta4", "meta5", "meta6", "meta7", "meta8", "meta9", "meta10")
